(function($) {
  'use strict';
  $(function() {
    if ($("#baby1Chart").length) {
      var baby1ChartCtx = document.getElementById('baby1Chart').getContext('2d');
      var baby1Chart = new Chart(baby1ChartCtx, {
        type: 'line',
        data: {
          labels: ['Day 1', 'Day 2', 'Day 3', 'Day 4', 'Day 5', 'Day 6', 'Day 7'],
          datasets: [{
            label: 'Yellowness Index',
    ...
    if ($("#lightChart").length) {
      var baby2ChartCtx = document.getElementById('lightChart').getContext('2d');
      var baby1Chart = new Chart(baby2ChartCtx, {
        type: 'line',
        data: {
          labels: ['Day 1', 'Day 2', 'Day 3', 'Day 4', 'Day 5', 'Day 6', 'Day 7'],
          datasets: [{
